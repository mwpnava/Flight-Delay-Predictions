...
and predicting flight delays. One dataset has a year’s worth of all US flight delay info [from Kaggle](https://www.kaggle.com/datasets/usdot/flight-delays?select=flights.csv/) and the other dataset has been gathered 
...
- Cleaned/transformed/merge dataset contains ... retrieve from [Georgia Tech Box 1](https://gatech.box.com/s/wuzelnupcqsr80o2ymcsj7my9a22w5mz)
...
- flight_delay.pkl is a file to utilize a pre-trained ML model in Streamlit
