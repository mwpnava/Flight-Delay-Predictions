...
with st.container():
    ...
    def main():
        html_temp = """
        <div class='tableauPlaceholder' id='viz1681918703427' style='position: relative'>
            <noscript>
                <a href='#'>
                    <img alt='Dashboard 4 (2) ' src='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;Me&#47;MeanFlightDelaysbyMonth&#47;Dashboard42&#47;1_rss.png' style='border: none' />
                </a>
            </noscript>
            <object class='tableauViz'  style='display:none;'>
                <param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' /> 
                <param name='embed_code_version' value='3' /> 
                <param name='site_root' value='' />
                <param name='name' value='MeanFlightDelaysbyMonth&#47;Dashboard42' />
                <param name='tabs' value='no' />
                <param name='toolbar' value='yes' />
                <param name='static_image' value='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;Me&#47;MeanFlightDelaysbyMonth&#47;Dashboard42&#47;1.png' /> 
                <param name='animate_transition' value='yes' />
                <param name='display_static_image' value='yes' />
                <param name='display_spinner' value='yes' />
                <param name='display_overlay' value='yes' />
        ...
        <script type='text/javascript'>                    
            var divElement = document.getElementById('viz1681918703427');                    
            var vizElement = divElement.getElementsByTagName('object')[0];                    
            if ( divElement.offsetWidth > 800 ) { 
                vizElement.style.width='800px';
                vizElement.style.height='527px';
